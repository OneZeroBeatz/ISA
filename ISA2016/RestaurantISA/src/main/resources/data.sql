...
insert into smena(vremeod, vremedo, restoran_id) values ('15:00', '24:00', (select id from restoran where naziv='Restoran 1'));
...
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (2,1,true, -1, '2017-03-28 08:00:00', 10, 1, -1, -1, '2017-03-28');
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (2,1,true, -1, '2017-02-28 08:00:00', 9, 2, -1, -1, '2017-02-28');
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (2,1,false, -1, '2017-03-01 08:00:00', 2, 3, -1, -1, '2017-03-01');
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (1,1,true, -1, '2017-01-28 08:30:00', 7, 4, -1, -1, '2017-01-28');
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (1,2,true, -1, '2017-02-25 08:30:00', 2, 5, -1, -1, '2017-02-25');
insert into poseta_restoranu (gost_id, restoran_id, obavljena, ocena, termin, br_sati, sto_id, ocena_obroka, ocena_usluge, datumrez) values (2,2,true, -1, '2017-02-28 11:30:00', 5, 3, -1, -1, '2017-02-28');
